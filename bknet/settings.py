# Django settings for bknet project.
import os.path

BASE_DIR = os.path.normpath(os.path.join(os.path.split(__file__)[0], os.pardir))
def rel(path):
...
ALLOWED_HOSTS = ['www.benkuhn.net', 'benkuhn.webfactional.com']
...
WSGI_APPLICATION = 'bknet.wsgi.application'
